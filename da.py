...
introduce2 = play.new_text (words = 'Создай мелодия, нажимая на клавиши', x = 0, y = 150)

key_play_melody = play.new_box (color = "light green", border_color='black', border_width=1 , x=-100, y= -170, width = 160, height = 50)
kmp = play.new_text(words = 'играть', x=-100, y= -170, font_size=20)

key_clear_melody = play.new_box (color = "light pink", border_color='black', border_width=1 , x=100, y= -170, width = 160, height = 50)
kmp = play.new_text(words = 'удалить', x=100, y= -170, font_size=20)
